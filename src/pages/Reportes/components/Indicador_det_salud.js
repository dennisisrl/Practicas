...
const Indicador_det_salud = () => {
    ...
    <br></br>
    <div className='indicInseg'> <h3>Indicador de Deterioro de la Salud</h3></div>
    <br></br>
    ...
    <table className=' table-bordered '>   
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Indicador deterioro de la salud	</td>
          <th>Codigo: </th>
          <td> DI-TH-SO-DS-003</td>
        </tr>
        <tr>
          <th>Finalidad</th>
          <td>Analizar las consecuencias que ocasionan un deterioro de la salud	</td>
          <th></th>
          <th></th>
        ...
        <tr>
          <th>Calculo</th>
          <td> = (No. de enfermedades laborales /  No. de colaboradores) * 100</td>
          <th></th>
          <th></th>
      ...
      <table className='table table-bordered' padding="2px">
        ...
        <tbody>
          <tr  className='espacio1'>
            ...
            <td>1878</td>
            <td>0,05%</td>
            <td>Sospecha de dermatosis laboral</td>
            <td>Cambio temporal de puesto de trabajo</td>
          ...
          <tr>
            ...
            <td>1878</td>
            <td>0,16%</td>
            <td>Sospecha hernia inguinal, hombro doloroso, Lumbalgia por hernia discal</td>
            <td>Limitación de actividades laborales, Certificado de CME, Programa higiene postural y pausas activas</td>
