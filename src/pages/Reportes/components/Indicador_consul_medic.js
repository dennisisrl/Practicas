...
const Indicador_consul_medic = () => {
    ...
    <br></br>
    <div className='indicInseg'> <h3>Indicador de Consultas Médicas</h3></div>
    <br></br>
    ...
    <table className=' table-bordered '>   
      ...
      <tbody>
        ...
        <tr>
          ...
          <th>Codigo: </th>
          <td> DI-TH-SO-CM-007</td>
        </tr>
        <tr>
          <th>Finalidad</th>
          <td>Prevenir, diagnosticar o tratar las enfermedades, y mantener y promover la salud de los empleados											
</td>
          <th></th>
          <th></th>
        ...
        <tr>
          <th>Calculo</th>
          <td> = No. de consultas médicas diarias </td>
          <th></th>
          <th></th>
      ...
      <table className='table table-bordered' padding="2px">
        ...
        <tbody>
          <tr  className='espacio1'>
            ...
            <td>1647</td>
            <td>Planificacion</td>
            <td>Atenciones morbimortalidad general y covid</td>
          ...
          <tr>
            ...
            <td>1520</td>
            <td>1520</td>
            <td>Atenciones de morbimortalidad general y ocupacional</td>
            <td>Atenciones morbimortalidad general y covid</td>
