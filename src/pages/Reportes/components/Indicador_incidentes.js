...
const Indicador_incidentes = () => {
    ...
    <br></br>
    <div className='indicInseg'> <h3>Indicador de Incidentes</h3></div>
    <br></br>
    ...
    <table className=' table-bordered '>   
      ...
      <tbody>
        ...
        <tr>
          <th>Calculo</th>
          <td> = (No. de incidentes peligrosos / No. de incidentes reportados) * 100</td>
          <th></th>
          <th></th>
      ...
      <table className='table table-bordered' padding="2px">
        ...
        <tbody>
          <tr  className='espacio1'>
            ...
            <td>0</td>
            <td>0%</td>
            <td>No se registraron incidentes</td>
            <td></td>
          ...
          <tr>
            ...
            <td>0</td>
            <td>2%</td>
            <td>Se registró un incidente no incapacitante</td>
            <td>Campañas de prevención de riesgos laborales con frecuencia, Capacitaciones, actualización de señalética, entrega de EPP de acuerdo al riesgo al que esta expuesto el trabajador. 			
</td>
