...
const Indicador_trab_aptos = () => {
    ...
    <br></br>
    <div className='indicInseg'> <h3>Indicador de trabajadores Aptos</h3></div>
    <br></br>
    ...
    <table className=' table-bordered '>   
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Indicador trabajores aptos </td>
          <th>Codigo: </th>
          <td> DI-TH-SO-TA-004		
</td>
        </tr>
        <tr>
          <th>Finalidad</th>
          <td>Identificar en forma temprana las posibles alteraciones temporales o permanentes de salud del trabajador											
</td>
          <th></th>
          <th></th>
        ...
        <tr>
          <th>Calculo</th>
          <td> = (No. de trabajadores aptos / No. de trabajadores evaluados) * 100											
</td>
          <th></th>
          <th></th>
      ...
      <table className='table table-bordered' padding="2px">
        ...
        <tbody>
          <tr  className='espacio1'>
            ...
            <td>68</td>
            <td>67.65%</td>
            <td>Evaluación Ocupacional de ingreso y posocupacional</td>
            <td>Induccion de medidas preventivas</td>
          ...
          <tr>
            ...
            <td>65.90%</td>
            <td>Evaluación Ocupacional de ingreso y posocupacional</td>
            <td>Seguimiento de equipo multidisciplinario			
</td>
          ...
          <tr>
            ...
            <td>53</td>
            <td>194</td>
            <td>EVALUACIONES OCUPACIONALES </td>
            <td>Seguimiento de equipo multidisciplinario			
</td>
