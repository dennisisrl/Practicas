...
import {Datos_trab_aptos} from './Datos_Indicadores/Datos_trab_aptos';
import {
  Chart as ChartJS,
  BarElement,
  CategoryScale,
...
const Indicador_trab_aptos = () => {
  const state = {
    data: {
      labels: Datos_trab_aptos.map(o => o.Mes),
      datasets: [
        {
          label: 'Resultados %',
          ...
          borderColor: '',
          borderWidth: 1,
          data: Datos_trab_aptos.map(o => o.Resultados)
        }
      ]
    },
    options: {
      ...
      plugins: {
        title: {
          display: true,
          text: 'Porcentaje de trabajadores aptos'
        }
      }
    }
  };
    ...
    return (
        ...
        <br></br>
        <div className='indicInseg'> <h3>Salud Ocupacional - Indicador de trabajadores aptos </h3></div>
        <br></br>
        ...
        <table className=' table-bordered '>   
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Indicador trabajadores aptos </td>
              <th>Codigo: </th>
              <td> DI-TH-SO-TA-004</td>
            </tr>
            <tr>
              <th>Finalidad</th>
              <td colspan="3">Identificar en forma temprana las posibles alteraciones temporales o permanentes de salud del trabajador</td>
             
             
            </tr>
            <tr>
              <th>Calculo</th>
              <td colspan="3">   = (No. de trabajadores aptos / No. de trabajadores evaluados) * 100 </td>
...
export default Indicador_trab_aptos;
